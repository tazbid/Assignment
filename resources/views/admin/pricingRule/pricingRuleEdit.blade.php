...
<ol class="breadcrumb float-sm-left">
    ...
    <li class="breadcrumb-item active">Pricing Rule Edit</li>
</ol>
@endsection
@section('content')
<div class="container">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header" style="background: #F67E7D">
                    <h5 class="text-white">Update Pricing Rule Info</h5>
                </div>
                <div class="card-body">
                    <div class="row d-flex justify-content-center align-items-center">
                        <div class="col-lg-10 col-md-10">
                            <form id="pricingRuleUpdateForm">
                                <input type="hidden" id="id" name="id" value="{{$pricingRule->id}}">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control" id="pricing_rule" name="pricing_rule" value="{{$pricingRule->pricing_rule}}"
                                    ...
                                    <div class="col-md-6 mb-3" style="padding-top: 10px;">
                                        <button id="btn-user-insert" type="submit" class="btn btn-primary save__btn"
                                            data-loading-text="<span class='spinner-border spinner-border-sm' role='status' aria-hidden='true'></span> Updating Pricing Rule..."
                                            data-normal-text="Update Pricing Rule">
                                            <span class="ui-button-text">Update Pricing Rule</span>
                                        </button>
                                    </div>
                                </div>
                            </form>
...
<input type="hidden" id="pricing_rule_weight_id" value="{{$pricingRule->weight_id}}">
<input type="hidden" id="pricing_rule_delivery_route_id" value="{{$pricingRule->delivery_route_id}}">
<input type="hidden" id="pricing_rule_delivery_type_id" value="{{$pricingRule->delivery_type_id}}">
<input type="hidden" id="pricing_rule_expiration_date" value="{{$pricingRule->expiration_date}}">

<script>
    $(document).ready(() => {

        $('#weight_id').val($("#pricing_rule_weight_id").val());
        $('#delivery_route_id').val($("#pricing_rule_delivery_route_id").val());
        $('#delivery_type_id').val($("#pricing_rule_delivery_type_id").val());
        $('#expiration_date').val($("#pricing_rule_expiration_date").val());
         ...
         * @return
         */
        $('#pricingRuleUpdateForm').submit(function (e) {
            e.preventDefault();
        }).validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    url: "{{ url('admin/pricing/rule/update') }}",
                    method: "POST",
                    data: formData,
